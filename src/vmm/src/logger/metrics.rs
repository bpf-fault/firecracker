...
pub struct PerformanceMetrics {
    ...
    /// Measures the snapshot live create time, at the VMM level, in microseconds.
    pub vmm_live_create_snapshot: SharedStoreMetric,
    /// Measures the snapshot live-bpf create time, at the VMM level, in microseconds.
    pub vmm_live_bpf_create_snapshot: SharedStoreMetric,
...
impl PerformanceMetrics {
    ...
    pub const fn new() -> Self {
        Self {
            ...
            vmm_live_create_snapshot: SharedStoreMetric::new(),
            vmm_live_bpf_create_snapshot: SharedStoreMetric::new(),
